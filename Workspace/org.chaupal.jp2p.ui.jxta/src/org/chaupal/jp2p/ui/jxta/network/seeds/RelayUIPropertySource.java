...
public class RelayUIPropertySource extends AbstractSeedlistUIPropertySource {
	...
	public RelayUIPropertySource( NetworkConfigurator configurator) {
		...
		super.addPropertySource( new CollectionPropertySource<Object>( SeedTypes.RELAY.toString(), configurator.getRelaySeedURIs(), SeedProperties.RDV_SEED.toString()));
		super.addPropertySource( new CollectionPropertySource<Object>( SeedTypes.RELAY.toString(), configurator.getRelaySeedingURIs(), SeedProperties.RDV_SEEDING_URI.toString()));
	}
